...
- [ ] **Step 5: Verify esp32dev still builds**

Run: `pio run -e esp32dev`
Expected: SUCCESS. (Still not wired into `main.cpp` — proves standalone compilation only. `pio test -e native` unaffected; still 89/89.)
...
Run: `pio run -e esp32dev`
Expected: SUCCESS. (Not wired into `main.cpp` yet — proves standalone compilation. `pio test -e native` unaffected; still 89/89.)
...
Run: `pio run -e esp32dev`
Expected: SUCCESS. (Not wired into `main.cpp` yet. `pio test -e native` unaffected; still 89/89.)
